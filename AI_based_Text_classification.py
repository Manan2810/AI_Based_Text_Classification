...
path = '/Users/mananmehra/Desktop/AI_Based_Text_Classification/finance'
...
path = '/Users/mananmehra/Desktop/AI_Based_Text_Classification/hr'
for filename in os.listdir(path):
    if filename.endswith(".txt"):
        file_path = os.path.join(path, filename)
        with open(file_path, 'r') as file:
...
path = '/Users/mananmehra/Desktop/AI_Based_Text_Classification/rd'
for filename in os.listdir(path):
    if filename.endswith(".txt"):
        file_path = os.path.join(path, filename)
        with open(file_path, 'r') as file:
...
training_data = []
department_folders = {
    "Finance": "/Users/mananmehra/Desktop/AI_Based_Text_Classification/finance",
    "HR": "/Users/mananmehra/Desktop/AI_Based_Text_Classification/hr",
    "R&D": "/Users/mananmehra/Desktop/AI_Based_Text_Classification/rd"
}
